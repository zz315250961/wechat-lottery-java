...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '抽奖管理员', '00', '', '', '1', '', '$2b$12$Dwmi1hVBMo4gF4kOjivgW.6ev9Waj0QAyV5deUtwEHrwF/bqbcaki', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '抽奖系统管理员，初始密码 admin，上线前必须修改');
